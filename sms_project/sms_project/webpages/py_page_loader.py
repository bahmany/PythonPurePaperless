        ...
        for _row in _rows:
            ...
            for __row in __rows:
                ...
                for ___row in ___rows:
                    weight3=weight3+"<li>"+___row[1]+"</li>"
...
# برای اینکه راحتتر بتوان هش کرد
...
def create_grid(form_id,view_type):
    ...
    for row in rows:
        ...
        __tr=__tr+"""<td>
        <a href="#" onclick="showModal('py_page_loader.py?idsf={0}')">ویرایش</a>
        </td><td><a href="#" onclick="__del('{0}')">حذف</a></td>
...
# i put hv as validation for hacking purposes
    formhtml = ' <a href="#" onclick="submit_frm_'+f_english_form_name+'()">ثبت داده ها</a>  '+formhtml
