...
*/
(function($) {
var pasteEventName = (navigator.userAgent.match(/msie [6]/i) ? 'paste' : 'input') + ".maskedinput";
...
(navigator.userAgent.match(/msie [6]/i) ? moveCaret:function(){setTimeout(moveCaret,0)})();
})
