...
fileitemArr.append(form['file2'])
fileitemArr.append(form['file3'])
fileitemArr.append(form['file4'])
fileitemArr.append(form['file5'])
fileitemArr.append(form['file6'])
fileitemArr.append(form['file7'])
fileitemArr.append(form['file8'])
